...
$s = \text {There's-a-starman-waiting-in-the-sky}$

$k = 3$

The alphabet is rotated by $3$, matching the mapping above. The encrypted string is $\text {Wkhuh'v-d-vwdupdq-zdlwlqj-lq-wkh-vnb}$.
